 ...
 */
public class HiperEntropyMoveletsDiscovery<MO> extends HiperCeMoveletsDiscovery<MO> {
	 ...
	 */
	public HiperEntropyMoveletsDiscovery(List<MAT<MO>> trajsFromClass, List<MAT<MO>> data, List<MAT<MO>> train, List<MAT<MO>> test,
