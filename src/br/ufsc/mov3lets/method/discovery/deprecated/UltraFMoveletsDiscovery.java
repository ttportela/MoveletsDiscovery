 ...
 */
public class UltraFMoveletsDiscovery<MO> extends UltraMoveletsDiscovery<MO> implements TrajectoryDiscovery {
	 ...
	 */
	public UltraFMoveletsDiscovery(MAT<MO> trajectory, List<MAT<MO>> trajsFromClass, List<MAT<MO>> data, List<MAT<MO>> train, List<MAT<MO>> test,
	...
	public List<Subtrajectory> moveletsDiscovery(MAT<MO> trajectory, List<MAT<MO>> trajectories, int minSize, int maxSize, Random random) {
		...
		this.bestFilter = new OverlappingFeaturesFilter(0.5, null);  // ULTRA-F
...
//		candidatesOfSize = this.bestFilter.filter(candidatesOfSize); // ULTRA-F
