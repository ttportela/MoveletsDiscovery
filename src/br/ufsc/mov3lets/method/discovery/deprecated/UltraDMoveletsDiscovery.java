 ...
 */
public class UltraDMoveletsDiscovery<MO> extends UltraMoveletsDiscovery<MO> implements TrajectoryDiscovery {
	 ...
	 */
	public UltraDMoveletsDiscovery(MAT<MO> trajectory, List<MAT<MO>> trajsFromClass, List<MAT<MO>> data, List<MAT<MO>> train, List<MAT<MO>> test,
	...
	public List<Subtrajectory> moveletsDiscovery(MAT<MO> trajectory, List<MAT<MO>> trajectories, int minSize, int maxSize, Random random) {
		...
		this.bestFilter = new OverlappingFeaturesFilter(0.0, null);  // ULTRA-D
...
//		addStats("Pivot Candidates", candidatesOfSize.size());
		...
		candidates.addAll(candidatesOfSize);  // ULTRA-D
