 ...
 */
public class BKP_UltraMoveletsDiscovery<MO> extends FrequentMoveletsDiscovery<MO> implements TrajectoryDiscovery {
	 ...
	 */
	public BKP_UltraMoveletsDiscovery(MAT<MO> trajectory, List<MAT<MO>> trajsFromClass, List<MAT<MO>> data, List<MAT<MO>> train, List<MAT<MO>> test,
