 ...
 */
public class PrecomputeMoveletsDiscovery<MO> extends MasterMoveletsDiscovery<MO> {
	 ...
	 */
	public PrecomputeMoveletsDiscovery(MAT<MO> trajectory, List<MAT<MO>> trajsFromClass, List<MAT<MO>> data, List<MAT<MO>> train, List<MAT<MO>> test, QualityMeasure qualityMeasure, 
