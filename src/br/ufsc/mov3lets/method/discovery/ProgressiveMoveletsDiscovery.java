...
public class ProgressiveMoveletsDiscovery<MO> extends MoveletsDiscovery<MO> {
	 ...
	 */	
	public ProgressiveMoveletsDiscovery(MAT<MO> trajectory, List<MAT<MO>> trajsFromClass, List<MAT<MO>> data, List<MAT<MO>> train, List<MAT<MO>> test, QualityMeasure qualityMeasure, 
