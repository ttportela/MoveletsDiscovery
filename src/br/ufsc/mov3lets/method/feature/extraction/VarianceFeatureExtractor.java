...
import br.ufsc.mov3lets.method.feature.selection.StatisticalFeatureSelector;
import br.ufsc.mov3lets.method.feature.selection.VarianceFeatureSelector;
 ...
 *
 */
public class VarianceFeatureExtractor<MO> extends FeatureExtractor<MO> {

	@Override
	public List<AttributeDescriptor> updateTrajectories(Descriptor descriptor, List<AttributeDescriptor> attributes,
			List<MAT<MO>> train, List<MAT<MO>> test) {
		StatisticalFeatureSelector<MO> fs = new VarianceFeatureSelector<MO>();
