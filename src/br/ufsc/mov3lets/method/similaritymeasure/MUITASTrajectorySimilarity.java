 ...
 *
 */
public class MUITASTrajectorySimilarity extends TrajectorySimilarityMeasure {

	public MUITASTrajectorySimilarity(List<MAT<?>> data, Double threshold, 
...
//		this.outputer = new SimilarityMatrixOutputter(descriptor.getParamAsText("respath"), "MUITAS");
	}
