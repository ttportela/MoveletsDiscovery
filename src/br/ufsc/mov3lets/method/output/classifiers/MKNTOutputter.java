...
public class MKNTOutputter<MO> extends CSVOutputter<MO> {
	...
	protected Map<Feature, Integer> mapMovelets = new HashMap<Feature, Integer>();
...
//	}
	...
	protected void attributesToSets(List<MAT<MO>> trajectories, List<Feature> movelets, List<BitSet> attributeToTrajectories) {
	 ...
	 */
	protected void attributeToSetsDiscrete(List<MAT<MO>> trajectories, Feature movelet, List<BitSet> attributeToTrajectories) {
