 ...
 */
public class WeightedFrequencyQualityMeasure<MO> extends QualityMeasure<MO> {
...
////		this.TAU = tau;
//	}
	public WeightedFrequencyQualityMeasure(List<MAT<MO>> trajectories) {
		super(trajectories, 1, 1.0, "");
//		this.TAU = tau;
	}
	 ...
	 */
	public WeightedFrequencyQualityMeasure(List<MAT<MO>> trajectories, int samples, double sampleSize, String medium) {
...
//		double wf = ( (proportion * candidate.getPointFeatures().length) + (proportion * candidate.getSize()) ) / proportion;
		double wf = (proportion * ((candidate.getPointFeatures().length + candidate.getSize()) / 2.0)) / 2.0;
