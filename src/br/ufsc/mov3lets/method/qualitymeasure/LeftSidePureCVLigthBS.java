 ...
 */
public class LeftSidePureCVLigthBS<MO> extends LeftSidePureCVLigth<MO> {
	 ...
	 */
	public LeftSidePureCVLigthBS(List<MAT<MO>> trajectories, int samples, double sampleSize, String medium) {
