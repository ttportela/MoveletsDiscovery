...
def model_marc(dir_path):
    ...
    keys, vocab_size, num_classes, max_length, x_train, y_train, x_test, y_test = loadTrajectories(dir_path)
...
# Load data:
def loadTrajectories(dir_path, tid_col='tid',
